...
public class RockSaltBlock extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:rock_salt")
	public static final Block block = null;

	public RockSaltBlock(FartsysAdditionsModElements instance) {
		super(instance, 62);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(StinkyThingsItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Melts snow!"));
		}
