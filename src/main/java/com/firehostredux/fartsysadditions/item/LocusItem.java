...
public class LocusItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:locus")
	public static final Item block = null;

	public LocusItem(FartsysAdditionsModElements instance) {
		super(instance, 32);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:locus")),
					new Item.Properties().group(StinkyThingsItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("locus");
		}
