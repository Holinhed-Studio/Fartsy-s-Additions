...
public class MetalMetalItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:metal_metal")
	public static final Item block = null;

	public MetalMetalItem(FartsysAdditionsModElements instance) {
		super(instance, 34);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:metalmetal")),
					new Item.Properties().group(StinkyThingsItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("metal_metal");
		}
