...
public class ArtificialSunItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:artificial_sun")
	public static final Item block = null;

	public ArtificialSunItem(FartsysAdditionsModElements instance) {
		super(instance, 11);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:artificialsun")),
					new Item.Properties().group(StinkyThingsItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("artificial_sun");
		}
