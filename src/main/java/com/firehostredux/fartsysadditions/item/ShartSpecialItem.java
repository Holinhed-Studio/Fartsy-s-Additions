...
public class ShartSpecialItem extends FartsysAdditionsModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(StinkyThingsItemGroup.tab).maxStackSize(64).rarity(Rarity.EPIC)
					.food((new Food.Builder()).hunger(50).saturation(50f).setAlwaysEdible()
