...
public class OutOfTimeItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:out_of_time")
	public static final Item block = null;

	public OutOfTimeItem(FartsysAdditionsModElements instance) {
		super(instance, 40);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:outoftime")),
					new Item.Properties().group(StinkyThingsItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("out_of_time");
		}
